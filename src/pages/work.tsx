          ...
          <div className="grid items-start grid-cols-3 gap-12 mt-12">
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center transition duration-500 ease-in-out bg-black bg-opacity-50 rounded-lg opacity-0 group-hover:opacity-100 backdrop-filter backdrop-blur-sm">
