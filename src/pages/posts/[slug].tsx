  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://sammagee.me/posts/${post.slug}`}
        />
        ...
        <meta
          ...
          content={`https://sammagee.me/images/posts/${post.slug}`}
        />
          ...
          <header className="mt-3">
            ...
            <div className="flex items-end justify-between mt-3">
              <div className="flex-1">
                <p
                  className="!mt-3 !mb-0 text-gray-300"
                  aria-label={`Published by: ${post.author}`}
                >
                  {post.author}
                </p>
