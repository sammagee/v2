...
export default function MobileNav() {
  ...
  return (
    <div className="relative sm:hidden">
      <button
        className="relative flex items-center justify-center -mr-3 text-gray-400 transition-colors duration-200 ease-in-out border-2 border-transparent border-dashed rounded-full select-none w-14 h-14 hover:bg-gray-500 hover:bg-opacity-10 focus:bg-gray-500 focus:bg-opacity-10 focus:text-white hover:text-white focus:border-brand-500 focus:outline-none"
      ...
      <Transition show={isOpen} as={Fragment}>
        <Dialog className="sm:hidden" static open={isOpen} onClose={() => setIsOpen(false)} initialFocus={initialFocusRef}>
          <Transition.Child
            as={Fragment}
                ...
                <div className="flex flex-col flex-1 overflow-y-auto">
                  ...
                  <div className="flex flex-col items-center px-6 py-6 space-y-6 xs:py-8 xs:px-12">
                    ...
                    <Tooltip
                      ...
                      placement="top"
                    >
                      <a className="inline-flex items-center justify-center w-full h-12 px-5 space-x-3 font-semibold transition duration-200 ease-in-out origin-bottom transform border-2 rounded-lg hover:bg-brand-400 focus:bg-brand-400 focus:bg-opacity-10 hover:bg-opacity-10 hover:scale-105 border-brand-400 text-brand-400 active:scale-100 focus:outline-none focus:border-dashed" href="mailto:sam@magee.one">
